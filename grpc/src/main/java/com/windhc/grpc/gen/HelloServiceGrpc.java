...
public final class HelloServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.windhc.grpc.gen.HelloService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.windhc.grpc.gen.HelloRequest,
      com.windhc.grpc.gen.HelloResponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello",
      requestType = com.windhc.grpc.gen.HelloRequest.class,
      responseType = com.windhc.grpc.gen.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.windhc.grpc.gen.HelloRequest,
      com.windhc.grpc.gen.HelloResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<com.windhc.grpc.gen.HelloRequest, com.windhc.grpc.gen.HelloResponse> getHelloMethod;
    if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
          HelloServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<com.windhc.grpc.gen.HelloRequest, com.windhc.grpc.gen.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.windhc.grpc.gen.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.windhc.grpc.gen.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void hello(com.windhc.grpc.gen.HelloRequest request,
        io.grpc.stub.StreamObserver<com.windhc.grpc.gen.HelloResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.windhc.grpc.gen.HelloRequest,
                com.windhc.grpc.gen.HelloResponse>(
                  this, METHODID_HELLO)))
          .build();
    }
  }
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public com.windhc.grpc.gen.HelloResponse hello(com.windhc.grpc.gen.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.windhc.grpc.gen.HelloResponse> hello(
        com.windhc.grpc.gen.HelloRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((com.windhc.grpc.gen.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.windhc.grpc.gen.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.windhc.grpc.gen.HelloServiceOuterClass.getDescriptor();
    }
